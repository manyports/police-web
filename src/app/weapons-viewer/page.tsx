  ...
  const weapons: WeaponInfo[] = [
    {
      ...
      name: "АК-74М",
      type: "assault-rifle",
      description: "Автомат Калашникова модернизированный, основной автомат Вооружённых Сил Республики Казахстан. Принят на вооружение после распада СССР и является стандартным оружием казахстанских военнослужащих и сотрудников правоохранительных органов.",
      details: {
        caliber: "5,45×39 мм",
        weight: "3,6 кг",
        length: "943 мм",
    ...
    },
    {
      ...
      type: "pistol",
      description: "9 мм пистолет Макарова – табельное оружие офицерского состава и сотрудников правоохранительных органов Республики Казахстан. Используется для поражения противника на коротких расстояниях. Отличается надежностью и простотой в обслуживании.",
      details: {
        caliber: "9×18 мм",
        weight: "0,73 кг",
        length: "161 мм",

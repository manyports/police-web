    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="w-full mb-16">
        ...
        >
          ...
          >
            Мы команда 24, участвующая на хакатоне Law-and-code 2025. Наш проект направлен на создание инновационной платформы для тренировки и обучения сотрудников правоохранительных органов с использованием современных технологий.
          </motion.p>
